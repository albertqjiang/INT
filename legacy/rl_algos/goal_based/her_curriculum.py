...
def train_on_seed(seed, configuration, her=True, resume=False):
    ...
    for degree in range(1, 1 + configuration["total_degrees"]):
        ...
        while update < total_updates_per_degree:
            ...
            training_info[degree]["updates"].append(update)
            ...
            if len(lower_buffer) >= batch_size and len(higher_buffer) >= batch_size and \
                ...
                training_info[degree]["time"].append({
                ...
                training_info[degree]["lower td error"].extend(lower_td_errors)
                training_info[degree]["higher td error"].extend(higher_td_errors)
...
if __name__ == "__main__":
    # TODO: Fix the problem of unable to set argument to true
    import argparse
